...
type 'a abstract
type existential_abstract : immutable_data with (type mod portable) abstract =
  | Mk : ('a : value mod portable) abstract -> existential_abstract
[%%expect{|
type 'a abstract
Lines 2-3, characters 0-67:
2 | type existential_abstract : immutable_data with (type mod portable) abstract =
...
Error: The kind of type "existential_abstract" is value
       ...
       But the kind of type "existential_abstract" must be a subkind of
         immutable_data with (type mod portable) abstract
